...
import UIPackageTableNotReadyText from '@salesforce/label/c.UIPackageTableNotReadyText';
import UIPackageTableNotReadyTitle from '@salesforce/label/c.UIPackageTableNotReadyTitle';
import UIPackageInstallReadyTitle from '@salesforce/label/c.UIPackageInstallReadyTitle';
import UIPackageInstallReady from '@salesforce/label/c.UIPackageInstallReady';
import UIPackageAlreadyInstalled from '@salesforce/label/c.UIPackageAlreadyInstalled';
import UIPackageAlreadyInstalledTitle from '@salesforce/label/c.UIPackageAlreadyInstalledTitle';
...
export default class PackageScreen extends LightningElement {
    ...
    label = {
        ...
        UIPackageTableNotReadyText,
        UIPackageTableNotReadyTitle,
        UIPackageInstallReadyTitle,
        UIPackageInstallReady,
        UIPackageAlreadyInstalled,
        UIPackageAlreadyInstalledTitle
    };
    columns = [
    ...
    getPackageTable() {
        ...
        .then(result => {
            ...
            this.showTables = result.OrgReadyForInstallation;
        ...
        .catch(error => {
            this.systemLogger.log('Error', error, this.recordId, 'packageScreen#getPackageTable');
            this.isLoading = false;
            this.error = error;
        });
    }
    ...
    installPackages() {
        ...
        .catch(error => {
            this.systemLogger.log('Error', error, this.recordId, 'packageScreen#installPackages');
            this.isLoading = false;
            this.error = error;
        });
    }
    ...
    registerErrorListener() {
        onError(error => {
            this.systemLogger.log('Error', error, this.recordId, 'packageScreen#registerErrorListener');
        });
    }
}