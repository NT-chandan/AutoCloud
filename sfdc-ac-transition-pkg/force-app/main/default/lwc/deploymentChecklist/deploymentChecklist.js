...
import deploymentChecklistDescriptionEmpty from '@salesforce/label/c.DeploymentChecklistDescriptionEmpty'
...
export default class DeploymentChecklist extends LightningElement {
    ...
    label = {
        ...
        deploymentChecklistDescriptionEmpty,
    ...
    get hasContent() {
        return this.deploymentSections.length;
    }

    get pageDescription() {
        return this.hasContent ? this.label.deploymentChecklistDescription : this.label.deploymentChecklistDescriptionEmpty;
    }
    ...
    generatePackage(event) {
        ...
        saveDeploymentChecklist({assessmentId: this.recordId, itemsToDeployJson: JSON.stringify(itemsToDeploy)})
            ...
            .catch((error) => {
                this.systemLogger.log('Error', error, this.recordId, 'deploymentChecklist#generatePackage');
                this.isLoading = false;
            });
